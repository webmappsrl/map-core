...
* **directive:** ✨ add WmMapTrackRecordDirective for tracking locations on the map ([#53](https://github.com/webmappsrl/map-core/issues/53)) ([c30c25f](https://github.com/webmappsrl/map-core/commit/c30c25f659dc9cf873baf1e8a88d44843927b13c))
...
* **directive:** ✨ enhance POI marker creation with error handling and taxonomy support ([54c352b](https://github.com/webmappsrl/map-core/commit/54c352bd5c246ec7a3f22e803c0bd25ae80990ba))
...
* **layer.directive:** now expose color of selected track ([2b03e42](https://github.com/webmappsrl/map-core/commit/2b03e4210ba307ac334b6c0913ee2f0fcd9e7b22))
...
* **ma.component:** add reset rotation ([f9b3ecb](https://github.com/webmappsrl/map-core/commit/f9b3ecba4b24e1b5d86ed32ef466fefbb30f2199))
* **map-core:** ✨ add show_image_on_map feature for POI rendering ([c18fcab](https://github.com/webmappsrl/map-core/commit/c18fcabb863f40d2446076b88f160e0fdcb9ea00))
...
* **oc:7639:** add featuresInLocationRange pipeline and fix quality issues ([9e20e36](https://github.com/webmappsrl/map-core/commit/9e20e369fb8950a25264842729eb3a2c2c6ad967))
* **oc:7646:** extend poi type filter to track related pois ([944ddc9](https://github.com/webmappsrl/map-core/commit/944ddc9662abb4c8ed72d867175ca70c75a27c3e))
...
* **pois:** add poi interactions ([e5d2ae8](https://github.com/webmappsrl/map-core/commit/e5d2ae8bf0293c7e50ef1c4014f7522457514ee7))
* **position:** add accuracy circle ([0f356d0](https://github.com/webmappsrl/map-core/commit/0f356d0bd9240c4b0b124317d619ad2b1b357cd3))
...
* **styles:** add ref on tracks ([66fd85d](https://github.com/webmappsrl/map-core/commit/66fd85dfd6ebf08aad1cabfb091904a66e67ce3f))
* **styles:** add start end icons ([9b88247](https://github.com/webmappsrl/map-core/commit/9b88247c283507246c62a47da8da6cb57c3d119b))
* **tiles:** tilesadd no tile map ([37c842d](https://github.com/webmappsrl/map-core/commit/37c842db37e99af9fbafab6aa917f3967b7b16c8))
...
* **track.directive:** now take as input the color of track ([31a4e37](https://github.com/webmappsrl/map-core/commit/31a4e371c6561da1f58fd94868228a613924c9ed))
...
* **directive:** 🐛 correct style function binding in WmMapLayerDirective oc:7337 ([556ba8a](https://github.com/webmappsrl/map-core/commit/556ba8aaf449b9e08ef2f5c6a742bb5d6390dea4))
...
* **httpRequest:** 🐛 update fetch request to disable caching ([32e71ea](https://github.com/webmappsrl/map-core/commit/32e71ea28db416981b590b2351c95d57d10b1bb0))
...
* **map:** 🐛 improve attribution display and styling ([3ff69fc](https://github.com/webmappsrl/map-core/commit/3ff69fc5e3c421ce6452f9a895d2b19bc8c46598))
...
* **mapInit:** now expose observable ([95b8649](https://github.com/webmappsrl/map-core/commit/95b8649e8b987b796c34bfc05e207fee48f9aff1))
...
* **oc:7989:** fix Karma/test config for CI ([#57](https://github.com/webmappsrl/map-core/issues/57)) ([ce0324c](https://github.com/webmappsrl/map-core/commit/ce0324ca9290910e377699bf1156d83e4aa25e21))
* **oc:8114:** rimuovi flash visivo ECPOI impostando visible:false all'init ([#59](https://github.com/webmappsrl/map-core/issues/59)) ([833c499](https://github.com/webmappsrl/map-core/commit/833c499500b04b01e696211426097e6978d6a216))
...
* **poi-filter-box:** change css ([47f9e32](https://github.com/webmappsrl/map-core/commit/47f9e3297415d5d3ab08db2b97db34411dd96932))
* **pois.directive:** blank map when clicking on tooltip ([8d1fb40](https://github.com/webmappsrl/map-core/commit/8d1fb403e196eddff615567288376b51d417ea11))
* **pois.directive:** changes fix render pois guard ([ae8410a](https://github.com/webmappsrl/map-core/commit/ae8410a1daa517414afeb93e57cf1995493cf1aa))
...
* **refactor:** update  import path ([2acd8e6](https://github.com/webmappsrl/map-core/commit/2acd8e6667b3f16fce3857a43588541081be7e27))
...
* **test:** change project structure ([903ba54](https://github.com/webmappsrl/map-core/commit/903ba5481fa5d21362b082bd2c3ff0b5089a9f0a))
...
* **components:** 🔧 set `standalone` property to false for all components and directives ([11d025d](https://github.com/webmappsrl/map-core/commit/11d025d4965e5ff08f47c02288a81caf6ee273a2))
* **controls:** ✨ add tile layer selection event and update attribution display ([5a4749a](https://github.com/webmappsrl/map-core/commit/5a4749a7a84674a5812bbbd841ee5267156e71e4))
* **controls:** ✨ refactor control toggle functionality ([b68fd47](https://github.com/webmappsrl/map-core/commit/b68fd47bb36b4d81aa43cbc7f73c72faf3402def))
...
* **tiles:** ✨ add tile URL building functionality and enhance download methods oc:7803 ([1660011](https://github.com/webmappsrl/map-core/commit/16600117b17a80ab60e5653de38cdb9947f4183f))
